        ...
        categories: [
            {
                ...
                sounds: [
                    { id: 'light-rain', name: 'Light Rain', desc: 'Gentle patter', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21v-2m-4 2v-2m8 2v-2M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"/></svg>', generator: 'externalAudio', url: '/audio/light-rain.mp3' },
                    { id: 'heavy-rain', name: 'Heavy Rain', desc: 'Intense downpour', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 19v4m5-4v4m5-4v4"/></svg>', generator: 'externalAudio', url: '/audio/heavy-rain.mp3' },
                    { id: 'thunder', name: 'Thunder', desc: 'Distant rumble', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>', generator: 'externalAudio', url: '/audio/thunder.mp3' },
                ]
            },
            {
                name: 'Nature Sounds',
                ...
                sounds: [
                    { id: 'forest', name: 'Forest', desc: 'Wind through trees', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>', generator: 'externalAudio', url: '/audio/forest.mp3' },
            ...
            },
            {
                ...
                sounds: [
                    { id: 'ocean-waves', name: 'Ocean Waves', desc: 'Rolling surf', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 2a4 4 0 00-4 4c0 3.5-4 6-4 10a8 8 0 0016 0c0-4-4-6.5-4-10a4 4 0 00-4-4z"/></svg>', generator: 'externalAudio', url: '/audio/ocean-waves.mp3' },
                    { id: 'river-stream', name: 'River Stream', desc: 'Babbling brook', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2 12c2-2 4-2 6 0s4 2 6 0 4-2 6 0M2 17c2-2 4-2 6 0s4 2 6 0 4-2 6 0M2 7c2-2 4-2 6 0s4 2 6 0 4-2 6 0"/></svg>', generator: 'externalAudio', url: '/audio/river-stream.mp3' },
                    { id: 'waterfall', name: 'Waterfall', desc: 'Rushing cascade', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"/></svg>', generator: 'externalAudio', url: '/audio/waterfall.mp3' },
                ]
            },
            {
                name: 'Musical',
                ...
                sounds: [
                    { id: 'singing-bowls', name: 'Tibetan Bowls', desc: 'Deep resonance', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z"/></svg>', generator: 'externalAudio', url: '/audio/tibetan-bowl.mp3' },
                    ...
                    { id: 'piano', name: 'Soft Piano', desc: 'Gentle melodies', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z"/></svg>', generator: 'externalAudio', url: '/audio/soft-piano.mp3' },
                    { id: 'handpan', name: 'Handpan', desc: 'Resonant bell tones', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', generator: 'externalAudio', url: '/audio/handpan.mp3' },
                    { id: 'flute', name: 'Bamboo Flute', desc: 'Airy whistles', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>', generator: 'externalAudio', url: '/audio/bamboo-flute.mp3' },
                ]
            },
            {
                name: 'Focus',
            ...
            },
            {
                ...
                sounds: [
                    { id: 'premium-piano', name: 'Piano Background', desc: 'Relaxing track', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z"/></svg>', generator: 'externalAudio', url: '/audio/piano-bg.mp3' },
                    { id: 'premium-sleep', name: 'Sleep Lullaby', desc: 'Ambient sleep', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"/></svg>', generator: 'externalAudio', url: '/audio/sleep-lullaby.mp3' },
                    { id: 'premium-meditate', name: 'Rain Meditation', desc: 'Deep calm', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>', generator: 'externalAudio', url: '/audio/rain-meditation.mp3' },
                    { id: 'premium-forest', name: 'Ambient Forest Rain', desc: 'Immersive woods', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg>', generator: 'externalAudio', url: '/audio/ambient-forest-rain.mp3' },
                    { id: 'premium-asmr', name: 'Sleep Rain ASMR', desc: 'Tingling relaxation', icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"/></svg>', generator: 'externalAudio', url: '/audio/sleep-rain-asmr.mp3' },
                ]
            }
        ],
